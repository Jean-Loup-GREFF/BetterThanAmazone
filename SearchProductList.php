...
<p><?php 
         ...
         $searchPrice=htmlentities($_POST["budget"],ENT_QUOTES, "UTF-8");
         $searchCategorie=htmlentities($_POST["categorie"],ENT_QUOTES, "UTF-8");}
         else{
             $searchEntries=False;
         }
...
<TABLE>
<CAPTION> </CAPTION>
<?php if ($searchEntries==False){
    $productsList=getAllProducts();
    $column=0;
    foreach($productsList as $product){
        echo '<TD><p ><br/><a id="productname" href="produit">'.$product["name"].'</a><br /><br/><img id="imageminiature" "src="'.$product["image"].' /><br /><img id="etoiles" src="5etoiles.png" /><br/> '.$product[unit_price].' euros<br/><br/> </p></TD>';
