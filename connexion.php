<?php
	...
	function getIdByUser($pseudo) {return getFromRequest("SELECT * FROM `users` WHERE `username` = \"".$pseudo."\"",["id", "firstname", "lastname", "username", "color", "email", "billing_adress_id", "delivery_adress_id", "created_at", "updated_at"]);}
