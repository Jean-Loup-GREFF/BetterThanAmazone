<?php
	...
	function getUserByUsername($username) { return getFromRequest("SELECT `u`.* FROM `users` `u` WHERE `u`.`username` = \"".$username."\" COLLATE SQL_Latin1_General_CP1_CS_AS", ["id", "firstname", "lastname", "username", "color", "email", "billing_adress_id", "delivery_adress_id", "created_at", "updated_at"]);}
	function getUserByEmailAndPassword($mail, $password) { return getFromRequest("SELECT `u`.* FROM `users` `u` WHERE `u`.`email` = \"".$mail."\" COLLATE SQL_Latin1_General_CP1_CS_AS AND `u`.`password` = \"".$password."\" COLLATE SQL_Latin1_General_CP1_CS_AS", ["id", "firstname", "lastname", "username", "color", "email", "billing_adress_id", "delivery_adress_id", "created_at", "updated_at"]);} 
	function getUserByUsernameAndPassword($username, $password) { return getFromRequest("SELECT `u`.* FROM `users` `u` WHERE `u`.`username` = \"".$username."\" COLLATE SQL_Latin1_General_CP1_CS_AS AND `u`.`password` = \"".$password."\" COLLATE SQL_Latin1_General_CP1_CS_AS", ["id", "firstname", "lastname", "username", "color", "email", "billing_adress_id", "delivery_adress_id", "created_at", "updated_at"]);}
	...
	function getUserByEmail($userMail) {return getFromRequest("SELECT * FROM `users` WHERE `email` = \"".$userMail."\" COLLATE SQL_Latin1_General_CP1_CS_AS",["id", "firstname", "lastname", "username", "color", "email", "billing_adress_id", "delivery_adress_id", "created_at", "updated_at"]);}
