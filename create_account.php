...
<body id='accountbody'>
	...
	<form id='accountform'>
		...
		<input class="InscriptionField" type="text" name="address1" placeholder="Street, number..."><br><br>
		<input class="InscriptionField" type="text" name="address2" placeholder="Appartement number..."><br><br>
